...
public class OHashQ<A extends Comparable<A>> {
    ...
    public OHashQ(int n) {
        this.size = n * 2;
        this.hashTable = new HNode[this.size];
    ...
    public String toString() {
        return "OHashQ [hashTable=" + Arrays.toString(hashTable) + "]";
    }
    ...
    public static void main(String[] args) {
        OHashQ<Integer> hashTable = new OHashQ<>(9);
        hashTable.add(10);
        hashTable.add(22);
        hashTable.add(31);
        hashTable.add(4);
